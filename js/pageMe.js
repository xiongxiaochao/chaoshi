        ...
        createHtml: function () {
            ...
            if (totalNum > 6) {
                ...
                if (pageNum < 5) {
                    ...
                    for (var i = 1; i < 6; i++) {
                        if (pageNum !== i) {
                            content.push("<button data-id='a1' type='button'>" + i + "</button>");
                        } else {
                            content.push("<button data-id='a1' type='button' class='current'>" + i + "</button>");
                        }
                    }
                    content.push(". . .");
                    content.push("<button data-id='a1' type='button'>" + totalNum + "</button>");
                } else {
                    ...
                    if (pageNum < totalNum - 3) {
                        ...
                        content.push("<button data-id='a1' type='button'>" + 1 + "</button>");
                        content.push(". . .");
                ...
                for (var i = 1; i < totalNum + 1; i++) {
                    if (pageNum !== i) {
                        content.push("<button class='a1' type='button'>" + i + "</button>");
                    } else {
                        content.push("<button class='a1' type='button' class='current'>" + i + "</button>");
                    }
                }
            }
